parcelRequire = function(e, r, t, n) {
    ...
    "lESK": [function(require, module, exports) {
        ...
        const e = require("./utils"),
            s = require("../utils");
        class r {}
        exports.MessageFormatter = r, r.makeRequest = ((r, t) => {
            return {
    ...
    "csOC": [function(require, module, exports) {
        ...
        Object.defineProperty(exports, "__esModule", {
            value: !0
        }), exports.METHODS = void 0, exports.METHODS = {
    ...
    "zQsh": [function(require, module, exports) {
        ...
        var e = this && this.__createBinding || (Object.create ? function(e, s, t, i) {
                ...
                void 0 === i && (i = t), e[i] = s[t]
            }),
            s = this && this.__exportStar || function(s, t) {
                for (var i in s) "default" === i || Object.prototype.hasOwnProperty.call(t, i) || e(t, s, i)
            };
        Object.defineProperty(exports, "__esModule", {
            value: !0
        });
        ...
        class i {
            constructor(e = null, s = !1) {
                this.allowedOrigins = null, this.callbacks = new Map, this.debugMode = !1, this.isValidMessage = (({
                    ...
                    let r = !0;
                    return Array.isArray(this.allowedOrigins) && (r = void 0 !== this.allowedOrigins.find(s => s.test(e))), !i && n && o && r
                    ...
                    const {
                        id: s
                    } = e, t = this.callbacks.get(s);
                    t && (t(e), this.callbacks.delete(s))
                }), this.send = ((e, s) => {
                    const i = t.MessageFormatter.makeRequest(e, s);
                    if ("undefined" == typeof window) throw new Error("Window doesn't exist");
                    return window.parent.postMessage(i, "*"), new Promise(e => {
                        this.callbacks.set(i.id, s => {
                            e(s)
                        })
                    })
                }), this.allowedOrigins = e, this.debugMode = s, window.addEventListener("message", this.onParentMessage)
            }
        }
        exports.default = i, s(require("./methods"), exports);
    }, {
    ...
    "VZwL": [function(require, module, exports) {
        ...
        class e {
            constructor(t) {
                this.txServiceUrl = null, this.communicator = t
            }
            async getBySafeTxHash(t) {
                if (!this.txServiceUrl) throw new Error("ENV information hasn't been synced yet or there was an error during the process");
                ...
                try {
                    ...
                    if (200 !== e.status) throw new Error("Failed to get the transaction. Either safeTxHash is incorrect or transaction hasn't been indexed by the service yet");
                    return await e.json()
                } catch (s) {
                    throw s
                }
    ...
    "lAWO": [function(require, module, exports) {
        ...
        Object.defineProperty(exports, "__esModule", {
            value: !0
        }), exports.RPC_CALLS = void 0, exports.RPC_CALLS = {
            eth_call: "eth_call",
    ...
    "ThoU": [function(require, module, exports) {
        ...
        class n {
            constructor(t = {}) {
                if ("undefined" == typeof window) throw new Error("Error initializing the sdk: window is undefined");
                const {
                    whitelistedDomains: e = null,
                    debug: n = !1
                } = t;
                this.communicator = new r.default(e, n), this.eth = new o.Eth(this.communicator), this.txs = new i.TXs(this.communicator), this.bootstrap()
            }
            async bootstrap() {
                const {
                    txServiceUrl: t
    ...
    "kVpi": [function(require, module, exports) {
        ...
        exports.default = o.default, t(require("./sdk"), exports), t(require("./types"), exports), t(require("./communication/methods"), exports), t(require("./communication/messageFormatter"), exports);
        var i = require("./utils");

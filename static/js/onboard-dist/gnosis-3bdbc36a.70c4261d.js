parcelRequire = function(e, r, t, n) {
    ...
    "audJ": [function(require, module, exports) {
                ...
                var e = o(regeneratorRuntime.mark(function e(r) {
                    return regeneratorRuntime.wrap(function(e) {
                        for (;;) switch (e.prev = e.next) {
                            case 0:
                                return e.t1 = i, e.next = 3, require("_bundle_loader")(require.resolve("@gnosis.pm/safe-apps-sdk"));
                            case 3:
                                return e.t2 = e.sent.default, e.t3 = new e.t2, e.next = 7, (0, e.t1)(e.t3);
                            case 7:
                                if (e.t0 = !!e.sent, !e.t0) {
                                    e.next = 10;
                                    break
                ...
                wallet: function() {
                    var e = o(regeneratorRuntime.mark(function e(t) {
                        ...
                        return regeneratorRuntime.wrap(function(e) {
                            for (;;) switch (e.prev = e.next) {
                                case 0:
                                    return n = t.createModernProviderInterface, e.next = 3, require("_bundle_loader")(require.resolve("@gnosis.pm/safe-apps-sdk"));
                                case 3:
                                    return e.t0 = e.sent.default, o = new e.t0, e.next = 7, require("_bundle_loader")(require.resolve("@gnosis.pm/safe-apps-provider"));
                                case 7:
                                    return a = e.sent, s = a.SafeAppProvider, e.next = 11, i(o);
                                case 11:
                                    if (c = e.sent) {
                                        e.next = 14;
                                        break
                                ...
                                case 14:
                                    return u = new s(c, o), e.abrupt("return", {
                                        provider: u,
                                        interface: r(r({}, n(u)), {}, {
                                            connect: function() {
        ...
        "@gnosis.pm/safe-apps-sdk": [
            ["src.358b2a1b.js", "kVpi"], "kVpi"
        ],
        "@gnosis.pm/safe-apps-provider": [
            ["dist.e4ab0f9b.js", "l7WL"], "l7WL"
        ]
    }],
